...
fluidTemperatureRanges = {
    "Air": (-40, 600),
    "Water (saturated liquid)": (0, 200),
    "Water (saturated vapor)": (50, 250),
    "Ethylene glycol 20%": (-5, 55),
    "Ethylene glycol 40%": (-20, 40),
    "Propylene glycol 20%": (-5, 55),
    "Propylene glycol 40%": (-15, 45),
    "Thermal fluid Duratherm 600": (45, 275),
    "Thermal fluid Duratherm LT": (50, 240),
    "Butane (saturated liquid)": (-45, 45),
    "Butane (saturated vapor)": (-45, 45),
    "Propane (saturated liquid)": (-45, 45),
    "Propane (saturated vapor)": (-45, 45),
    "Carbon dioxide CO2 (saturated liquid)": (-50, 20),
    "Carbon dioxide CO2 (saturated vapor)": (-50, 20),
    "Ammonia (saturated liquid)": (-45, 45),
    "Ammonia (saturated vapor)": (-45, 45),
    "R-12 (saturated liquid)": (-45, 45),
    "R-12 (saturated vapor)": (-45, 45),
    "R-22 (saturated liquid)": (-45, 45),
    "R-22 (saturated vapor)": (-45, 45),
    "R-134a (saturated liquid)": (-45, 45),
    "R-134a (saturated vapor)": (-45, 45),
    "R-404A (saturated liquid)": (-45, 45),
    "R-404A (saturated vapor)": (-45, 45),
    "R-504A (saturated liquid)": (-45, 45),
    "R-504A (saturated vapor)": (-45, 45),
    "R-508B (saturated liquid)": (-80, -5),
    "R-508B (saturated vapor)": (-80, -5),
}
